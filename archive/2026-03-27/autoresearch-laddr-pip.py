#!/usr/bin/env python3
"""
AutoResearch on Laddr - uses pip instead of uv
"""
...
pip3 install torch numpy tiktoken matplotlib pandas

# Run training (simplified - may need adjustment for the actual train.py)
python3 train.py 2>&1 | head -50
...
echo "=== TRAINING COMPLETE ==="''',
    ...
    def run_baseline(self):
        """Run full baseline."""
        print("=" * 60)
        print("🚀 AutoResearch Baseline (Laddr + pip)")
        print("=" * 60)
